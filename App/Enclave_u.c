...
sgx_status_t insert_secret(sgx_enclave_id_t eid, int* retval, const int* s)
{
	sgx_status_t status;
	ms_insert_secret_t ms;
	ms.ms_s = s;
...
sgx_status_t retrieve_secret(sgx_enclave_id_t eid, int* retval, int* s)
{
	sgx_status_t status;
	ms_retrieve_secret_t ms;
	ms.ms_s = s;
...
sgx_status_t insert_contract(sgx_enclave_id_t eid, int* retval, const char* s)
{
	sgx_status_t status;
	ms_insert_contract_t ms;
	ms.ms_s = s;
...
sgx_status_t sign_and_retrieve(sgx_enclave_id_t eid, int* retval, char* s)
{
	sgx_status_t status;
	ms_sign_and_retrieve_t ms;
	ms.ms_s = s;
...
sgx_status_t make_public_key(sgx_enclave_id_t eid, int* retval, uint8_t* pub)
{
	sgx_status_t status;
	ms_make_public_key_t ms;
	ms.ms_pub = pub;
